...
export async function createCommande(data: CreateCommandeDTO): Promise<ApiResponse<CommandeCommerciale>> {
  ...
  const payload = {
    ...
    lignes: data.lignes.map(l => ({
      ...
      frais_livraison_fournisseur: l.fraisLivraisonFournisseur,
      frais_livraison_client: l.fraisLivraisonClient,
      type_livraison: l.typeLivraison,
      taux_commission: l.tauxCommission,
      reduction: l.remise,
