...
- Name: barro\rapports.spec.ts >> Mme Barro — Rapports Commerciaux >> les filtres de date sont accessibles
- Location: e2e\barro\rapports.spec.ts:78:3
...
Locator: getByLabel(/date début/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByLabel(/date début/i)
