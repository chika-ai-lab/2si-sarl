...
- Name: barro\rapports.spec.ts >> Mme Barro — Rapports Commerciaux >> affiche le titre et les 6 KPI cards
- Location: e2e\barro\rapports.spec.ts:6:3
...
Locator: getByRole('heading', { name: /rapports commerciaux/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /rapports commerciaux/i })
