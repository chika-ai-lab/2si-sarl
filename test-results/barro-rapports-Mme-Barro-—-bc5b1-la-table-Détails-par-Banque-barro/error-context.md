...
- Name: barro\rapports.spec.ts >> Mme Barro — Rapports Commerciaux >> affiche la table Détails par Banque
- Location: e2e\barro\rapports.spec.ts:47:3
...
Locator: getByText(/détails par banque/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/détails par banque/i)
