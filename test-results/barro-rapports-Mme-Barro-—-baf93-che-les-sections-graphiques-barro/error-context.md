...
- Name: barro\rapports.spec.ts >> Mme Barro — Rapports Commerciaux >> affiche les sections graphiques
- Location: e2e\barro\rapports.spec.ts:23:3
...
Locator: getByText(/évolution du chiffre d'affaires/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/évolution du chiffre d'affaires/i)
