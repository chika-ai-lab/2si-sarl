...
- Name: barro\rapports.spec.ts >> Mme Barro — Rapports Commerciaux >> le bouton Exporter PDF est visible et cliquable
- Location: e2e\barro\rapports.spec.ts:105:3
...
Locator: getByRole('button', { name: /exporter pdf/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /exporter pdf/i })
