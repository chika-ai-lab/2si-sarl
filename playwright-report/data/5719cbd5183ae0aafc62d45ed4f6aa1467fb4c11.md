...
- Name: logistique\livraisons.spec.ts >> Logistique — Livraisons >> le tab 'En attente' filtre les BL en attente
- Location: e2e\logistique\livraisons.spec.ts:42:3
...
Locator: getByText(/aucune livraison/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/aucune livraison/i)
          ...
          - generic [ref=e126]:
            - generic [ref=e127]:
              - button "Tous(8)" [ref=e128] [cursor=pointer]:
                - text: Tous
                - generic [ref=e129]: (8)
              - button "En attente" [active] [ref=e130] [cursor=pointer]
